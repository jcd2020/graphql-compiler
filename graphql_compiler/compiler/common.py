...
def compile_graphql_to_cypher(schema, graphql_string, type_equivalence_hints=None):
    ...
    Returns:
        a CompilationResult object
    """
    lowering_func = ir_lowering_cypher.lower_ir
    query_emitter_func = emit_cypher.emit_code_from_ir
    return _compile_graphql_generic(
        CYPHER_LANGUAGE, lowering_func, query_emitter_func,
        schema, graphql_string, type_equivalence_hints, None)
